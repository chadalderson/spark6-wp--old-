  ...
  */
  class WP_EX_Aviary_editor
  {
    ...
    public function aviary_js(){
      ...
      ?>
    <!-- Load Feather code -->
    <script type="text/javascript" src="<?php echo $this->path.'/father.js';?>"></script>
    <style>
    ...
    <script type="text/javascript">
        ...
        function fixed_position_lightbox(){
          jQuery("#avpw_controls").css('position','fixed');
          jQuery("#avpw_controls").css('top','40px');
          jQuery("#avpw_control_cancel_pane").css('position','fixed');
          jQuery("#avpw_control_cancel_pane").css('top','44px');
        }
        ...
        var featherEditor = new Aviary.Feather({
                  ...
                  onLoad: function(){fixed_position_lightbox();}
              });
    ...
    public function aviary_ajax_save(){
        ...
        else
        {
          ...
          echo __('Image saved refresh the page to see it :).');
          die();
      }
    }
    /**
